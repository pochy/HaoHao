...
smoke-data-pipeline-snapshot-merge-conflict:
	node scripts/smoke-data-pipeline.mjs snapshot_merge_conflict

smoke-data-pipeline-snapshot-merge-composite:
	node scripts/smoke-data-pipeline.mjs snapshot_merge_composite
