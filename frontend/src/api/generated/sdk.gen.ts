...
/**
 * data pipeline review item detail を返す
 *
 * data pipeline review item detail を返す。
 *
 * file metadata、dataset、work table、query job、export の管理に使う endpoint です。
 ...
 * - `SESSION_ID` Cookie が必要です。状態変更 request では `X-CSRF-Token` も送ります。
 */
export const getDataPipelineReviewItem = <ThrowOnError extends boolean = false>(options: Options<GetDataPipelineReviewItemData, ThrowOnError>) => (options.client ?? client).get<GetDataPipelineReviewItemResponses, GetDataPipelineReviewItemErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'SESSION_ID',
            type: 'apiKey'
...
/**
 * data pipeline review item に comment を追加する
 *
 * data pipeline review item に comment を追加する。
 *
 * file metadata、dataset、work table、query job、export の管理に使う endpoint です。
 ...
 * - request body は `application/json` を基本にし、必須 field と enum は schema に従って指定します。
 */
export const commentDataPipelineReviewItem = <ThrowOnError extends boolean = false>(options: Options<CommentDataPipelineReviewItemData, ThrowOnError>) => (options.client ?? client).post<CommentDataPipelineReviewItemResponses, CommentDataPipelineReviewItemErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'SESSION_ID',
            type: 'apiKey'
...
/**
 * data pipeline review item の status を更新する
 *
 * data pipeline review item の status を更新する。
 *
 * file metadata、dataset、work table、query job、export の管理に使う endpoint です。
 ...
 * - request body は `application/json` を基本にし、必須 field と enum は schema に従って指定します。
 */
export const transitionDataPipelineReviewItem = <ThrowOnError extends boolean = false>(options: Options<TransitionDataPipelineReviewItemData, ThrowOnError>) => (options.client ?? client).post<TransitionDataPipelineReviewItemResponses, TransitionDataPipelineReviewItemErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'SESSION_ID',
            type: 'apiKey'
...
/**
 * data pipeline review item 一覧を返す
 *
 * data pipeline review item 一覧を返す。
 *
 * file metadata、dataset、work table、query job、export の管理に使う endpoint です。
 ...
 * - `SESSION_ID` Cookie が必要です。状態変更 request では `X-CSRF-Token` も送ります。
 */
export const listDataPipelineReviewItems = <ThrowOnError extends boolean = false>(options: Options<ListDataPipelineReviewItemsData, ThrowOnError>) => (options.client ?? client).get<ListDataPipelineReviewItemsResponses, ListDataPipelineReviewItemsErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'SESSION_ID',
            type: 'apiKey'
...
/**
 * 未保存 draft graph の schema と column warning を検証する
 *
 * 未保存 draft graph の schema と column warning を検証する。
 *
 * file metadata、dataset、work table、query job、export の管理に使う endpoint です。
 ...
 * - request body は `application/json` を基本にし、必須 field と enum は schema に従って指定します。
 */
export const validateDataPipelineDraft = <ThrowOnError extends boolean = false>(options: Options<ValidateDataPipelineDraftData, ThrowOnError>) => (options.client ?? client).post<ValidateDataPipelineDraftResponses, ValidateDataPipelineDraftErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'SESSION_ID',
            type: 'apiKey'
...
/**
 * managed SCD2 work table の key history rows を返す
 *
 * managed SCD2 work table の key history rows を返す。
 *
 * file metadata、dataset、work table、query job、export の管理に使う endpoint です。
 ...
 * - `SESSION_ID` Cookie が必要です。状態変更 request では `X-CSRF-Token` も送ります。
 */
export const getManagedDatasetWorkTableScd2History = <ThrowOnError extends boolean = false>(options: Options<GetManagedDatasetWorkTableScd2HistoryData, ThrowOnError>) => (options.client ?? client).get<GetManagedDatasetWorkTableScd2HistoryResponses, GetManagedDatasetWorkTableScd2HistoryErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'SESSION_ID',
            type: 'apiKey'
...
/**
 * Drive file に紐づく data pipeline review item 一覧を返す
 *
 * Drive file に紐づく data pipeline review item 一覧を返す。
 *
 * Drive file の OCR、product extraction、AI summary/classification に使う endpoint です。
 ...
 * - `SESSION_ID` Cookie が必要です。状態変更 request では `X-CSRF-Token` も送ります。
 */
export const listDriveFileDataPipelineReviewItems = <ThrowOnError extends boolean = false>(options: Options<ListDriveFileDataPipelineReviewItemsData, ThrowOnError>) => (options.client ?? client).get<ListDriveFileDataPipelineReviewItemsResponses, ListDriveFileDataPipelineReviewItemsErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'SESSION_ID',
            type: 'apiKey'
