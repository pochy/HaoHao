...
import { fetchPublicDriveShareLink } from '../api/drive'
  ...
  <section class="panel stack drive-public-panel">
    ...
    <template v-if="data">
      ...
      <div class="action-row">
        <a
          v-if="data.file && data.link.canDownload"
          class="primary-button link-button"
          :href="contentURL"
        >
          Download
        </a>
        <span v-else-if="data.file" class="status-pill danger">Download blocked</span>
      </div>
