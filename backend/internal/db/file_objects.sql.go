...
const getActiveFileObjectByIDForTenant = `-- name: GetActiveFileObjectByIDForTenant :one
...
type GetActiveFileObjectByIDForTenantParams struct {
	ID       int64 `json:"id"`
	TenantID int64 `json:"tenant_id"`
}

func (q *Queries) GetActiveFileObjectByIDForTenant(ctx context.Context, arg GetActiveFileObjectByIDForTenantParams) (FileObject, error) {
	row := q.db.QueryRow(ctx, getActiveFileObjectByIDForTenant, arg.ID, arg.TenantID)
	var i FileObject
	err := row.Scan(
		&i.ID,
		&i.PublicID,
